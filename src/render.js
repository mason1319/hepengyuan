...
const BLOG_VIDEO_URL = "https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260729_102822_0e6c87e8-c141-4744-bf32-ad30db296371.mp4";
...
export function renderBlogIndexPage(articles, baseUrl) {
  ...
  return documentShell({ title, description, canonical, jsonLd, bodyClass: "blog-document", body: `${blogVideoLayer()}<main id="content" class="blog-page"><section class="blog-hero"><div class="wrap"><p class="kicker">Personal blog / 个人微博</p><h1>把正在做的事，<span>写成可搜索的文章。</span></h1><p class="lead">这是何鹏远的公开写作空间：记录决策、方法、产品和长期实践。</p></div></section><div class="blog-video-spacer" aria-hidden="true"></div><section class="archive blog-index-content"><div class="wrap"><p class="count">${articles.length ? `已发布 ${articles.length} 篇` : "暂无已发布文章"}</p>${list}</div></section></main>` });
}
