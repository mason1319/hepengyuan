...
for (const expected of ["sanitizeImage", "createVideoPoster", "补封面", "mediaSavedWithoutPoster", "makeRetrySlug", "autoGenerated", "showModal", "confirmPendingDeletion", 'method: "DELETE"', "selectedFileInfo", "showUploadValidation", "正在处理并上传"]) {
